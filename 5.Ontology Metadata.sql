...
CREATE OR REPLACE TABLE ONT_OBJECT_SOURCE (
    ...
    OBJ_TYPE STRING,            -- e.g. 'Customer', 'Account' <This is the KG_NODE.NODE_TYPE>
    SOURCE_TABLE STRING,        -- e.g. 'KG_NODE'
    FILTER_SQL STRING,          -- e.g. 'NODE_TYPE = ''Customer''' <This is the KG_NODE.NODE_TYPE>
...
CREATE OR REPLACE TABLE ONT_LINK_SOURCE (
    ONTOLOGY_NAME STRING,
    LINK_TYPE STRING,           -- e.g. CUST_OWNS_PRODUCT | PRODUCT_TRANSACTIONS | CUSTOMER_TRANSACTIONS | CUSTOMER_DEVICE <This is the KG_EDGE.EDGE_TYPE>
    SOURCE_TABLE STRING,        -- e.g. 'KG_EDGE'
    FILTER_SQL STRING,          -- e.g. 'EDGE_TYPE = ''CUST_OWNS_PRODUCT''' <This is the KG_NODE.NODE_TYPE>
    MAPPING VARIANT,            -- JSON mapping of source columns to properties
...
CREATE OR REPLACE TABLE ONT_SHARED_PROPERTY (
    SHARED_PROP_NAME STRING PRIMARY KEY,   -- <This will be ENTITY_VIEW.VIEW_NAME.PROPS>
    BASE_TYPE STRING,                      -- <This will be DATATYPE FOR ENTITY_VIEW.VIEW_NAME.PROPS>
    DESCRIPTION STRING,
...
CREATE OR REPLACE TABLE ONT_PROPERTY (
    CLASS_NAME STRING,
    PROP_NAME STRING,
    DATA_TYPE STRING,                      -- <This will be DATATYPE FOR ENTITY_VIEW.VIEW_NAME.PROPS>
...
-- ======================================================================
-- ACTIONS (Operations)
-- CREATING TABLES - BUT NOT BEING USED IN THIS VERSION OF THE ONTOLOGY
-- ======================================================================
...
CREATE OR REPLACE TABLE ONT_CLASS_MAP (
    ...
    SUBTYPE_VALUE STRING,       -- The subtype value for this mapping - This is the KG_NODE.NODE_TYPE <CUSTOMER | ACCOUNT | TRANSACTION | DEVICE>
...
CREATE OR REPLACE TABLE ONT_REL_MAP (
    ...
    VIA_REL_VALUE STRING,       -- The concrete relationship type - KG_EDGE.EDGE_TYPE <CUST_OWNS_PRODUCT | PRODUCT_TRANSACTIONS | CUSTOMER_TRANSACTIONS | CUSTOMER_DEVICE>
...
CREATE OR REPLACE TABLE ONT_INTERFACE (
    INTERFACE_NAME STRING PRIMARY KEY,     -- e.g. 'Customer' 'Account'
    DESCRIPTION STRING
);
...
CREATE OR REPLACE TABLE OBJ_VIEW_DEF (
    OBJ_TYPE STRING,                       -- Object type, e.g. 'Customer'
    VIEW_NAME STRING,                      -- logical view name, e.g. 'V_CUSTOMER'
...
-- ==========================================================================================================
-- NOTE: ONT_CLASS_CLOSURE and REL_RESOLVED views would be dfined in abstract_views.sql with richer schemas
-- ==========================================================================================================